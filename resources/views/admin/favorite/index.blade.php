                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.favorite.show',$post->id)}} " class="btn btn-primary">Show</a>
                                            <a href="#" class="btn btn-danger" onclick="delete_post('{{ $post->id}}');">Remove</a>
                                            <form id="post-remove-{{$post->id}}" action="{{route('admin.favorite.remove', $post->id)}}" method="post" style="display: none;">
                                                @csrf
                                                @method('PUT')
                                            </form>
                                        </td>
