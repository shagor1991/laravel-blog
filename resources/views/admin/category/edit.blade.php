                        ...
                        <div class="body">
                            <form class="form-horizontal" action="{{ route('admin.category.update',$category->id)}}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Category Image</label>
                                    </div>

                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line {{ $errors->has('cimage') ? 'error': ''}}">
                                                <input type="file" class="form-control" name="cimage">
                                            </div>
                                            @if($errors->has('cimage'))
                                            <label id="name-error" class="error" for="name">{{$errors->first('cimage')}}</label>
                                            @endif
                                        </div>
                                    </div>
